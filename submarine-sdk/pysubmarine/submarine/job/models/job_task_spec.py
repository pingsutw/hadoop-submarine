...
class JobTaskSpec(object):
    ...
    def __init__(self, name=None, image=None, cmd=None, env_vars=None, resources=None, replicas=None, cpu=None, gpu=None, memory=None, local_vars_configuration=None):  # noqa: E501
